...
<Modal
	...
	disableFly={true}
	width="border dark:border-gray-700 h-[95dvh] w-[90dvw] pb-0 overflow-hidden rounded-2xl bg-white shadow-2xl outline-none dark:bg-gray-800 dark:text-gray-200 sm:h-[95dvh] xl:w-[980px] xl:h-[85dvh] 2xl:w-[1040px] 2xl:h-[75dvh]"
>
	{@render children?.()}
